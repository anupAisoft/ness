        ...
        <View>
         ...
         ref={myR}
           ...
           provider={PROVIDER_GOOGLE}
            ...
            //   latitudeDelta:0.00922, //0.0122,
            // longitudeDelta:0.00421
            //  Dimensions.get('window').width / Dimensions.get('window').height,
            }}>
                  {coordinates.coordinates && coordinates.coordinates.map((item,i)=>{
                return(
                   <Marker
                   key={i}
              coordinate={{
          ...
          <Search hideModal={hideModal} onRechange={onRechange}
           navigation={navigation} modalVisible={modalVisible} />
          {/* =================search=============== */}
          <ScrollView
            horizontal
